...
//		assertEquals("test-oidc-scope", scopeEntry.scopeKey(), "ServiceScope should have correct name");
//		Collection<Credential> credentials = scopeEntry.credentials();
...
//			credentials = serviceScope.credentials();
//			if (credentials.size() == 1) {
//				assertEquals("test-oidc-scope", serviceScope.scopeKey(),
...
//				assertEquals("another-oidc-scope", serviceScope.scopeKey(),
//						"ServiceScope should have correct name");
...
//
//		ScopeEntry scopeEntry = new ScopeEntry().credentials(credentials).scopeKey("test-oidc-scope");
//
